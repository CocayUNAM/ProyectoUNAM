...
//		data: [],
		...
		url: "http://localhost:8080/rest/CargaBatchService/lstCursos/",
...
function ultimoValor(){
	return $.ajax({
		url: "http://localhost:8080/rest/CargaBatchService/ultimoValor",
		type : 'GET',
		async: false
	});
}
...
function limpiarTabla(Curso){
	return $.ajax({
		url: "http://localhost:8080/rest/CargaBatchService/limpiarTabla/"+Curso,
		type : 'GET',
		async: false
	});
}
